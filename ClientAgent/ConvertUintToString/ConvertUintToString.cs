// ----------------------------------------------------------------------- 
// <copyright file="ConvertUintToString.cs" company="FHWN"> 
// Copyright (c) FHWN. All rights reserved. 
// </copyright> 
// <summary>Component class.</summary> 
// <author>Matthias Böhm</author> 
// -----------------------------------------------------------------------
namespace ConvertUintToString
{
    using System;
    ...
    /// <summary>
    /// This is the component class for converting unsigned integer to string.
    /// </summary>
    public class ConvertUintToString : IComponent
    {    
        /// <summary>
        /// Initializes a new instance of the <see cref="ConvertUintToString"/> class.
        /// </summary>
        public ConvertUintToString()
        {
        ...
        {
            get { return "Convert uint to string"; }
        }
